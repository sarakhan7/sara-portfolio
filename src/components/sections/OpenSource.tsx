      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {dark ? "intelligence" : "intelligence"}
            </Typography>{" "}
            and intention.
            <Default>
              <Avatar
          ...
          >
            Every tool is designed to be{" "}
            <Typography textColor="text.primary">elegant</Typography>,{" "}
            <Typography textColor="text.primary">intuitive</Typography>, and{" "}
            <Typography textColor="text.primary">deeply useful</Typography> — not just functional, but unforgettable.
            <br /><br />
